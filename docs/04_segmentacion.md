...
En la planificación radioterápica, los procesos de **contorneo** y **segmentación** se refieren a la identificación de regiones anatómicas de interés en las imágenes médicas del paciente (ver **Figura 7**). Aunque a veces se usan como sinónimos, en el ámbito clínico existe una sutil distinción entre ambos términos [38], [39] :

<div align="center">
  <img src="images/Imagen7.png" width="300px">
...
[← Anterior](03_imagenes_medicas.html) | [Siguiente: Deep Learning →](05_deep_learning.html)
